...
#define PROTOCOL_PEER_REQUEST_CHUNK     0b00010000
#define PROTOCOL_PEER_SEND_CHUNK        0b00011000
#define PROTOCOL_PEER_REQUEST_HASHES    0b00100000
#define PROTOCOL_PEER_SEND_HASHES       0b00110000
#define PROTOCOL_PEER_ESTABLISH_HASH    0b01000000
#define PROTOCOL_PEER_CONFIRM_HASH      0b01100000
